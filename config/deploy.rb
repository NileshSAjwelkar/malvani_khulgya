...
set :repo_url, 'https://github.com/NileshSAjwelkar/malvani_khulgya.git' # Edit this to match your repository
set :branch, :master
set :deploy_to, '/home/deploy/malvani_khulgya'

# set :rbenv_ruby, '2.3.3p222'
# server '18.216.24.164', user: 'deploy', roles: %w{web app db}
